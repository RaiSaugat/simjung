...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setIsSuccess(true);
        setFormState({ name: '', email: '', service: 'Back Office solutions', message: '' });
      } else {
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center py-32 px-6 overflow-hidden bg-[#1E1B4B] text-white relative">
        ...
        <div className="flex flex-col lg:flex-row gap-24 items-center lg:items-start">
          <div className="lg:w-1/2">
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-sky-400 font-black tracking-[0.4em] uppercase text-[10px]">Reach the Summit</span>
            </div>
            <h2 className="text-6xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85]">
              Let’s <span className="font-serif italic font-normal text-gradient">Elevate</span> <br/>
              Your Vision.
            </h2>
            <p className="text-xl text-slate-400 font-medium leading-relaxed max-w-lg mb-16 border-l-2 border-sky-400/20 pl-8">
              Scaling your business with Himalayan precision begins with an elegant collaboration. Our experts are ready to design your ascent.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
              <div className="group">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h4 className="font-black text-white/50 uppercase tracking-widest text-[10px]">Email Us</h4>
                </div>
                <p className="text-white font-bold text-lg">{CONTACT_DETAILS.email}</p>
              </div>
              ...
              <div className="group sm:col-span-2">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h4 className="font-black text-white/50 uppercase tracking-widest text-[10px]">Base Camp</h4>
                </div>
                <p className="text-white font-bold text-lg">{CONTACT_DETAILS.address}</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl p-12 md:p-16 rounded-[4rem] shadow-4xl border border-white/10 relative overflow-hidden">
              ...
              {isSuccess ? (
                <div className="relative z-10 flex flex-col items-center justify-center text-center py-20 animate-in fade-in zoom-in duration-700">
                  ...
                  <p className="text-slate-400 max-w-xs mx-auto">Our strategic leads will review your vision and contact you within 24 hours.</p>
                  <button 
                ...
                <form onSubmit={handleSubmit} className="relative z-10 space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] ml-2">Identity</label>
                      <input 
                        type="text" 
                    ...
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] ml-2">Channel</label>
                      <input 
                        type="email" 
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] ml-2">Objective</label>
                    <div className="relative">
                      ...
                      >
                        <option className="bg-[#1E1B4B]">Back Office solutions</option>
                        <option className="bg-[#1E1B4B]">Bookkeeping and Accounting</option>
                        <option className="bg-[#1E1B4B]">Software Development and Support</option>
                        <option className="bg-[#1E1B4B]">Civil Engineering and Architecture</option>
                        <option className="bg-[#1E1B4B]">AI Annotations</option>
                        <option className="bg-[#1E1B4B]">Strategic Partnership</option>
                      </select>
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] ml-2">Vision</label>
                    <textarea 
                      rows={4}
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {isSubmitting ? 'Transmitting...' : 'Initiate Connection'} <Send className="ml-4 w-4 h-4" />
                    </button>
                  </div>
                </form>
              )}
