            ...
            <div className="flex flex-col gap-4">
              ...
              <div className={`flex items-center gap-3 px-5 py-2.5 rounded-full bg-sky-50/50 border border-sky-100 self-start transition-all duration-1000 ${hasInteracted ? 'opacity-40 grayscale scale-95' : 'opacity-100 shadow-sm animate-pulse'}`}>
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-[#1E1B4B]">
                  {typeof window !== 'undefined' && window.innerWidth < 1024 ? 'Tap to Explore Verticals' : 'Hover to Explore Verticals'}
                </span>
              </div>
            </div>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className={`absolute transition-all duration-700 z-20 ${
                  isActive ? 'top-8 left-8 lg:top-10 lg:left-10' : 'top-8 left-1/2 -translate-x-1/2 lg:top-10'
                }`}>
                ...
                <div className={`flex flex-col h-full p-8 lg:p-16 pt-28 lg:pt-40 relative z-10 overflow-hidden transition-all duration-500 ${!isActive && 'lg:items-center'}`}>
                  ...
                  `}>
                    <h3 className={`font-black tracking-tight transition-colors duration-500 ${
                      isActive 
                  ...
                  <div className={`transition-all duration-500 ease-out ${
                    isActive ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95 pointer-events-none h-0 lg:h-auto overflow-hidden'
                  }`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-3 lg:gap-y-4 max-w-4xl">
                      {service.detailedOfferings.map((item, oIdx) => (
                        <div key={oIdx} className="flex items-center gap-3 py-2 lg:py-3 border-b border-slate-50 group/item hover:border-sky-50 transition-all">
                  ...
                  <div className={`absolute bottom-6 right-6 lg:bottom-8 lg:right-8 font-black text-[6rem] lg:text-[12rem] tracking-tighter leading-none select-none transition-all duration-1000 pointer-events-none ${
